  ...
  return (
    <div className="h-full w-64 overflow-hidden relative shrink-0 bg-gray-200 rounded-3xl">
      ...
      <div className="absolute bg-black/15 top-0 left-0 h-full w-full p-6 flex flex-col justify-between">
        <h2 className="bg-[#42069c] text-white rounded-full h-12 w-12 flex justify-center items-center text-2xl font-semibold">
          {props.id + 1}
        </h2>
        <div>
          ...
          <div className="flex justify-between">
            <button className="bg-[#2d016f] text-white font-medium px-8 py-2 rounded-full ">
              {props.tag}
            </button>
            <a href={props.link} target="_blank">
              <button className="bg-[#2d016f] text-white font-medium px-5 py-2 rounded-full ">
                <MoveRight />
              </button>
            </a>
          </div>
